...
public class PreferenceKeys {
    ...
    public static final String CameraNoiseReductionModePreferenceKey = "preference_noise_reduction_mode"; // n.b., this is for the Camera driver noise reduction mode, not Magic Camera's NR photo mode

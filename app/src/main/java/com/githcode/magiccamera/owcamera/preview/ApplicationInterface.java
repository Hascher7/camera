...
public interface ApplicationInterface {
    ...
    void requestCameraPermission(); // for Android 6+: called when trying to Magic Camera, but CAMERA permission not available
    ...
    void requestStoragePermission(); // for Android 6+: called when trying to Magic Camera, but WRITE_EXTERNAL_STORAGE permission not available
